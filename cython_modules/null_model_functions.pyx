...
def generate_samples(cnp.ndarray[cnp.float64_t, ndim=1] pool, cnp.ndarray[cnp.int64_t, ndim=1] indices,
                     int stop, int num_reals, int size):
    ...
    cdef cnp.ndarray[cnp.int64_t, ndim=1] indices_copy
    cdef int i, index
    cdef cnp.ndarray[bint, ndim=1] mask
