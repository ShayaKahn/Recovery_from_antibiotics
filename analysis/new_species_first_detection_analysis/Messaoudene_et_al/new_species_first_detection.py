...
def run_Messaoudene_new_species_first_detection_analysis() -> dict:
    """Run first-detection counts for all Messaoudene participants."""
...
if __name__ == "__main__":
    analysis_outputs = run_Messaoudene_new_species_first_detection_analysis()
