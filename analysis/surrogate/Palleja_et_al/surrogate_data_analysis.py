...
plot_SDA(outputs=results_sda, fig_size=(3.1, 4), sur_color="#8C2928", real_color="#51A246", ymin=-4.9314556423269575,
         ymax=10.899442828117659, dir=None, y_title='Standardized Jaccard similarity', naive=True)


results_plot = plot_SDA(outputs=results_sda, fig_size=(3.1, 4), sur_color="#8C2928",
