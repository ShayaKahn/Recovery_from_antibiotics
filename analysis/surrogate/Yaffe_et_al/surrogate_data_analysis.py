...
results_sda_rjsd = run_surrogate_analysis(dataset, timepoints_val=4, method="jensenshannon")

plot_SDA(outputs=results_sda_rjsd, fig_size=(22, 4), sur_color="#8C2928", real_color="#51A246", ymin=-5,
         show_y=True, legend=False, ymax=20, y_title='Standardized rJSD similarity', naive=True,
         dir="C:/Users/USER/OneDrive/Desktop/Recovery_from_antibiotics/Recovery_from_antibiotics/results/Yaffe_et_al/"
             "surrogate_data_analysis/sda_plot_rjsd")
...
results_plot = plot_SDA(outputs=results_sda, fig_size=(22, 4), sur_color="#8C2928", real_color="#51A246",
                        ymin=-5, ymax=20, dir="C:/Users/USER/OneDrive/Desktop/Recovery_from_antibiotics/"
                               "Recovery_from_antibiotics/results/Yaffe_et_al/surrogate_data_analysis/sda_plot",
...
results_plot_slow = plot_SDA_slow(outputs=results_sda, success_idx_input=results_plot["success_idx"],
                                  fail_idx_input=results_plot["fail_idx"], fig_size=(22, 4),
                                  sur_color="#8C2928", real_color="#51A246", ymin=-5, ymax=20, dir=
                                  "C:/Users/USER/OneDrive/Desktop/"
                                                                               "Recovery_from_antibiotics/"
                                  "Recovery_from_antibiotics/results/Yaffe_et_al/surrogate_data_analysis/sda_plot_slow")

save_sda_plot_results(results_plot_slow, "C:/Users/USER/OneDrive/Desktop/Recovery_from_antibiotics/"
                               "Recovery_from_antibiotics/results/Yaffe_et_al/surrogate_data_analysis", slow=True)
