...
results_sda_rjsd = run_surrogate_analysis(dataset, timepoints_val=2, method="braycurtis")
...
plot_SDA(outputs=results_sda_rjsd, fig_size=(9, 4), sur_color="#8C2928", real_color="#51A246", ymin=-0.05,
         show_y=True, legend=False, ymax=1, dir=None, y_title='Standardized rJSD similarity',
