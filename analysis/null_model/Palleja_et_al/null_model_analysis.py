...
results_nm = run_null_model_analysis(dataset, timepoints_val=1, num_reals=100)
order = np.load("C:/Users/USER/OneDrive/Desktop/Recovery_from_antibiotics/"
                               "Recovery_from_antibiotics/results/Palleja_et_al/surrogate_data_analysis/order.npy")

fig, ax = plot_NM_violin(outputs=results_nm, fig_size=(3.1, 4), sur_color="#787878", real_color="#1A72B780",
