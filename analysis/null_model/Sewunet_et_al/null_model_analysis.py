...
results_nm = run_null_model_analysis(dataset, timepoints_val=2)
order = np.load("C:/Users/USER/OneDrive/Desktop/Recovery_from_antibiotics/"
                               "Recovery_from_antibiotics/results/Sewunet_et_al/surrogate_data_analysis/order.npy")

fig, ax = plot_NM_violin(outputs=results_nm, fig_size=(9, 4), sur_color="#787878", real_color="#1A72B780",
