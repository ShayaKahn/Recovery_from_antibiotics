...
class NullModel:
    ...
    __slots__ = ('test_base_sample', 'test_ABX_sample', 'baseline_cohort', 'test_post_ABX_matrix',
                 'num_reals', 'timepoints', 'strict', 'subset_comp', 'subset', 'synthetic_samples',
                 'test_post_ABX_sample')
